...
* A minimal number of extra transitions is added (only for starting the loop, or none at all if one quantifies over
the loop index without an extra variable)
* A minimal number of extra variables is added, making states in traces more concise
